        ...
        <div className='form shadow-lg shadow-gray-500 mx-auto relative bounce'>
            ...
            <div className='relative'>
                <div className='absolute -top-12 left-16 grid grid-cols-3 gap-x-3'>
                    <a onClick={() => navigate("/deposit", {state:{userViewData}})} className='w-9 h-9 green flex justify-center items-center'><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-person-fill-up" viewBox="0 0 16 16" style={{ fill: 'white' }}>
                    <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.354-5.854 1.5 1.5a.5.5 0 0 1-.708.708L13 11.707V14.5a.5.5 0 0 1-1 0v-2.793l-.646.647a.5.5 0 0 1-.708-.708l1.5-1.5a.5.5 0 0 1 .708 0M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                    <path d="M2 13c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"/>
                    </svg>
                    </a>
                    <a onClick={() => navigate("/withdraw", {state:{userViewData}})}  className='w-9 h-9 red flex justify-center items-center'><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-person-fill-down" viewBox="0 0 16 16" style={{ fill: 'white' }}>
