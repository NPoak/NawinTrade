        ...
        <div className='form shadow-lg shadow-gray-500 mx-auto relative bounce'>
            ...
            <div className='relative'>
                <div className='absolute -top-12 left-16 grid grid-cols-4 gap-x-3'>
                    ...
                    <a onClick={() => navigate("/paymenthistory", {state:{userViewData}})} className='w-9 h-9 bg-orange-500 flex justify-center items-center cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-clock-history" viewBox="0 0 16 16" style={{ fill: 'white' }}>
                    ...
                    <a onClick={() => navigate("/tradinghistory", {state:{userViewData}})} className='w-9 h-9 bg-amber-400 flex justify-center items-center cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-cash-coin" style={{ fill: 'white' }} viewBox="0 0 16 16">
